...
import (
	"vpp-go-test/binapi/ikev2_types"
...
//   - child_sa - child SA data
//
// Ikev2ChildSaV2Details defines message 'ikev2_child_sa_v2_details'.
// InProgress: the message form may change in the future versions
type Ikev2ChildSaV2Details struct {
	Retval  int32                      `binapi:"i32,name=retval" json:"retval,omitempty"`
	ChildSa ikev2_types.Ikev2ChildSaV2 `binapi:"ikev2_child_sa_v2,name=child_sa" json:"child_sa,omitempty"`
}

func (m *Ikev2ChildSaV2Details) Reset()               { *m = Ikev2ChildSaV2Details{} }
func (*Ikev2ChildSaV2Details) GetMessageName() string { return "ikev2_child_sa_v2_details" }
func (*Ikev2ChildSaV2Details) GetCrcString() string   { return "1db62aa2" }
func (*Ikev2ChildSaV2Details) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *Ikev2ChildSaV2Details) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4      // m.Retval
	...
	size += 2      // m.ChildSa.Esn.BlockSize
	size += 1      // m.ChildSa.Esn.DhGroup
	size += 8      // m.ChildSa.Uptime
	return size
}
func (m *Ikev2ChildSaV2Details) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	...
	buf.EncodeUint16(m.ChildSa.Esn.BlockSize)
	buf.EncodeUint8(m.ChildSa.Esn.DhGroup)
	buf.EncodeFloat64(m.ChildSa.Uptime)
	return buf.Bytes(), nil
}
func (m *Ikev2ChildSaV2Details) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.ChildSa.SaIndex = buf.DecodeUint32()
	m.ChildSa.ChildSaIndex = buf.DecodeUint32()
	...
	m.ChildSa.Esn.BlockSize = buf.DecodeUint16()
	m.ChildSa.Esn.DhGroup = buf.DecodeUint8()
	m.ChildSa.Uptime = buf.DecodeFloat64()
	return nil
}
...
//   - sa_index - index of specific sa
//
// Ikev2ChildSaV2Dump defines message 'ikev2_child_sa_v2_dump'.
// InProgress: the message form may change in the future versions
type Ikev2ChildSaV2Dump struct {
	SaIndex uint32 `binapi:"u32,name=sa_index" json:"sa_index,omitempty"`
}

func (m *Ikev2ChildSaV2Dump) Reset()               { *m = Ikev2ChildSaV2Dump{} }
func (*Ikev2ChildSaV2Dump) GetMessageName() string { return "ikev2_child_sa_v2_dump" }
func (*Ikev2ChildSaV2Dump) GetCrcString() string   { return "01eab609" }
func (*Ikev2ChildSaV2Dump) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *Ikev2ChildSaV2Dump) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SaIndex
...
func (m *Ikev2ChildSaV2Dump) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *Ikev2ChildSaV2Dump) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SaIndex = buf.DecodeUint32()
	return nil
}

// IKEv2: Get the current sleep interval for the ikev2_manager_process
// Ikev2GetSleepInterval defines message 'ikev2_get_sleep_interval'.
type Ikev2GetSleepInterval struct{}

func (m *Ikev2GetSleepInterval) Reset()               { *m = Ikev2GetSleepInterval{} }
func (*Ikev2GetSleepInterval) GetMessageName() string { return "ikev2_get_sleep_interval" }
func (*Ikev2GetSleepInterval) GetCrcString() string   { return "51077d14" }
func (*Ikev2GetSleepInterval) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *Ikev2GetSleepInterval) Size() (size int) {
	if m == nil {
		return 0
	}
	return size
}
func (m *Ikev2GetSleepInterval) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *Ikev2GetSleepInterval) Unmarshal(b []byte) error {
	return nil
}

// IKEv2: Reply with the current sleep interval
//   - sleep_interval - current sleep interval in seconds
//
// Ikev2GetSleepIntervalReply defines message 'ikev2_get_sleep_interval_reply'.
type Ikev2GetSleepIntervalReply struct {
	Retval        int32   `binapi:"i32,name=retval" json:"retval,omitempty"`
	SleepInterval float64 `binapi:"f64,name=sleep_interval" json:"sleep_interval,omitempty"`
}

func (m *Ikev2GetSleepIntervalReply) Reset()               { *m = Ikev2GetSleepIntervalReply{} }
func (*Ikev2GetSleepIntervalReply) GetMessageName() string { return "ikev2_get_sleep_interval_reply" }
func (*Ikev2GetSleepIntervalReply) GetCrcString() string   { return "78ab91dc" }
func (*Ikev2GetSleepIntervalReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *Ikev2GetSleepIntervalReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
	size += 8 // m.SleepInterval
	return size
}
func (m *Ikev2GetSleepIntervalReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	buf.EncodeInt32(m.Retval)
	buf.EncodeFloat64(m.SleepInterval)
	return buf.Bytes(), nil
}
func (m *Ikev2GetSleepIntervalReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.SleepInterval = buf.DecodeFloat64()
	return nil
}
...
// IKEv2: Set sleep interval for ikev2_manager_process node
//   - timeout - sleep timeout duration in seconds
//
// Ikev2PluginSetSleepInterval defines message 'ikev2_plugin_set_sleep_interval'.
type Ikev2PluginSetSleepInterval struct {
	Timeout float64 `binapi:"f64,name=timeout" json:"timeout,omitempty"`
}

func (m *Ikev2PluginSetSleepInterval) Reset()               { *m = Ikev2PluginSetSleepInterval{} }
func (*Ikev2PluginSetSleepInterval) GetMessageName() string { return "ikev2_plugin_set_sleep_interval" }
func (*Ikev2PluginSetSleepInterval) GetCrcString() string   { return "b7c096ae" }
func (*Ikev2PluginSetSleepInterval) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *Ikev2PluginSetSleepInterval) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 8 // m.Timeout
...
func (m *Ikev2PluginSetSleepInterval) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	buf.EncodeFloat64(m.Timeout)
	return buf.Bytes(), nil
}
func (m *Ikev2PluginSetSleepInterval) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Timeout = buf.DecodeFloat64()
	return nil
}

// Ikev2PluginSetSleepIntervalReply defines message 'ikev2_plugin_set_sleep_interval_reply'.
type Ikev2PluginSetSleepIntervalReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *Ikev2PluginSetSleepIntervalReply) Reset() { *m = Ikev2PluginSetSleepIntervalReply{} }
func (*Ikev2PluginSetSleepIntervalReply) GetMessageName() string {
	return "ikev2_plugin_set_sleep_interval_reply"
}
func (*Ikev2PluginSetSleepIntervalReply) GetCrcString() string { return "e8d4e804" }
func (*Ikev2PluginSetSleepIntervalReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *Ikev2PluginSetSleepIntervalReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *Ikev2PluginSetSleepIntervalReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *Ikev2PluginSetSleepIntervalReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}
...
//   - sa - SA data
//
// Ikev2SaV2Details defines message 'ikev2_sa_v2_details'.
type Ikev2SaV2Details struct {
	Retval int32                 `binapi:"i32,name=retval" json:"retval,omitempty"`
	Sa     ikev2_types.Ikev2SaV2 `binapi:"ikev2_sa_v2,name=sa" json:"sa,omitempty"`
}

func (m *Ikev2SaV2Details) Reset()               { *m = Ikev2SaV2Details{} }
func (*Ikev2SaV2Details) GetMessageName() string { return "ikev2_sa_v2_details" }
func (*Ikev2SaV2Details) GetCrcString() string   { return "a616e604" }
func (*Ikev2SaV2Details) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *Ikev2SaV2Details) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4      // m.Retval
	size += 4      // m.Sa.SaIndex
	size += 64     // m.Sa.ProfileName
	size += 4      // m.Sa.State
	size += 8      // m.Sa.Ispi
	size += 8      // m.Sa.Rspi
	size += 1      // m.Sa.Iaddr.Af
...
func (m *Ikev2SaV2Details) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	buf.EncodeInt32(m.Retval)
	buf.EncodeUint32(m.Sa.SaIndex)
	buf.EncodeString(m.Sa.ProfileName, 64)
	buf.EncodeUint32(uint32(m.Sa.State))
	buf.EncodeUint64(m.Sa.Ispi)
	buf.EncodeUint64(m.Sa.Rspi)
	buf.EncodeUint8(uint8(m.Sa.Iaddr.Af))
	buf.EncodeBytes(m.Sa.Iaddr.Un.XXX_UnionData[:], 16)
...
func (m *Ikev2SaV2Details) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.Sa.SaIndex = buf.DecodeUint32()
	m.Sa.ProfileName = buf.DecodeString(64)
	m.Sa.State = ikev2_types.Ikev2State(buf.DecodeUint32())
	m.Sa.Ispi = buf.DecodeUint64()
	m.Sa.Rspi = buf.DecodeUint64()
	m.Sa.Iaddr.Af = ip_types.AddressFamily(buf.DecodeUint8())
	copy(m.Sa.Iaddr.Un.XXX_UnionData[:], buf.DecodeBytes(16))
...
// Dump all SAs
// Ikev2SaV2Dump defines message 'ikev2_sa_v2_dump'.
type Ikev2SaV2Dump struct{}

func (m *Ikev2SaV2Dump) Reset()               { *m = Ikev2SaV2Dump{} }
func (*Ikev2SaV2Dump) GetMessageName() string { return "ikev2_sa_v2_dump" }
func (*Ikev2SaV2Dump) GetCrcString() string   { return "51077d14" }
func (*Ikev2SaV2Dump) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *Ikev2SaV2Dump) Size() (size int) {
	if m == nil {
		return 0
	}
	return size
}
func (m *Ikev2SaV2Dump) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *Ikev2SaV2Dump) Unmarshal(b []byte) error {
	return nil
}
...
//   - sa - SA data
//
// Ikev2SaV3Details defines message 'ikev2_sa_v3_details'.
// InProgress: the message form may change in the future versions
type Ikev2SaV3Details struct {
	Retval int32                 `binapi:"i32,name=retval" json:"retval,omitempty"`
	Sa     ikev2_types.Ikev2SaV3 `binapi:"ikev2_sa_v3,name=sa" json:"sa,omitempty"`
}

func (m *Ikev2SaV3Details) Reset()               { *m = Ikev2SaV3Details{} }
func (*Ikev2SaV3Details) GetMessageName() string { return "ikev2_sa_v3_details" }
func (*Ikev2SaV3Details) GetCrcString() string   { return "85c9a941" }
func (*Ikev2SaV3Details) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *Ikev2SaV3Details) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4      // m.Retval
...
func (m *Ikev2SaV3Details) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
	...
	buf.EncodeUint16(m.Sa.Stats.NRetransmit)
	buf.EncodeUint16(m.Sa.Stats.NInitSaRetransmit)
	buf.EncodeFloat64(m.Sa.Uptime)
	return buf.Bytes(), nil
}
func (m *Ikev2SaV3Details) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	m.Sa.SaIndex = buf.DecodeUint32()
	m.Sa.ProfileName = buf.DecodeString(64)
	...
	m.Sa.Stats.NRetransmit = buf.DecodeUint16()
	m.Sa.Stats.NInitSaRetransmit = buf.DecodeUint16()
	m.Sa.Uptime = buf.DecodeFloat64()
	return nil
}

// Dump all SAs
// Ikev2SaV3Dump defines message 'ikev2_sa_v3_dump'.
// InProgress: the message form may change in the future versions
type Ikev2SaV3Dump struct{}

func (m *Ikev2SaV3Dump) Reset()               { *m = Ikev2SaV3Dump{} }
func (*Ikev2SaV3Dump) GetMessageName() string { return "ikev2_sa_v3_dump" }
func (*Ikev2SaV3Dump) GetCrcString() string   { return "51077d14" }
func (*Ikev2SaV3Dump) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *Ikev2SaV3Dump) Size() (size int) {
	if m == nil {
		return 0
	}
	return size
}
func (m *Ikev2SaV3Dump) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *Ikev2SaV3Dump) Unmarshal(b []byte) error {
	return nil
}
...
func file_ikev2_binapi_init() {
	...
	api.RegisterMessage((*Ikev2ChildSaV2Details)(nil), "ikev2_child_sa_v2_details_1db62aa2")
	api.RegisterMessage((*Ikev2ChildSaV2Dump)(nil), "ikev2_child_sa_v2_dump_01eab609")
	api.RegisterMessage((*Ikev2GetSleepInterval)(nil), "ikev2_get_sleep_interval_51077d14")
	api.RegisterMessage((*Ikev2GetSleepIntervalReply)(nil), "ikev2_get_sleep_interval_reply_78ab91dc")
	...
	api.RegisterMessage((*Ikev2PluginSetSleepInterval)(nil), "ikev2_plugin_set_sleep_interval_b7c096ae")
	...
	api.RegisterMessage((*Ikev2SaV2Details)(nil), "ikev2_sa_v2_details_a616e604")
	api.RegisterMessage((*Ikev2SaV2Dump)(nil), "ikev2_sa_v2_dump_51077d14")
	api.RegisterMessage((*Ikev2SaV3Details)(nil), "ikev2_sa_v3_details_85c9a941")
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*Ikev2ChildSaV2Details)(nil),
		(*Ikev2ChildSaV2Dump)(nil),
		(*Ikev2GetSleepInterval)(nil),
		(*Ikev2GetSleepIntervalReply)(nil),
		...
		(*Ikev2PluginSetSleepInterval)(nil),
		(*Ikev2PluginSetSleepIntervalReply)(nil),
		...
		(*Ikev2SaDetails)(nil),
		(*Ikev2SaDump)(nil),
		(*Ikev2SaV2Details)(nil),
		(*Ikev2SaV2Dump)(nil),
		(*Ikev2SaV3Details)(nil),
		(*Ikev2SaV3Dump)(nil),
