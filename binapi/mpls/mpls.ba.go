...
// mpls enabled interface details
// MplsInterfaceDetails defines message 'mpls_interface_details'.
type MplsInterfaceDetails struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
}

func (m *MplsInterfaceDetails) Reset()               { *m = MplsInterfaceDetails{} }
func (*MplsInterfaceDetails) GetMessageName() string { return "mpls_interface_details" }
func (*MplsInterfaceDetails) GetCrcString() string   { return "0b45011c" }
func (*MplsInterfaceDetails) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *MplsInterfaceDetails) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *MplsInterfaceDetails) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
...
func (m *MplsInterfaceDetails) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
}

// Dump mpls enabled interface(s)
//   - sw_if_index - sw_if_index of a specific interface, or -1 (default)
//     to return all MPLS enabled interfaces
//
// MplsInterfaceDump defines message 'mpls_interface_dump'.
type MplsInterfaceDump struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index,default=4294967295" json:"sw_if_index,omitempty"`
}

func (m *MplsInterfaceDump) Reset()               { *m = MplsInterfaceDump{} }
func (*MplsInterfaceDump) GetMessageName() string { return "mpls_interface_dump" }
func (*MplsInterfaceDump) GetCrcString() string   { return "f9e6675e" }
func (*MplsInterfaceDump) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *MplsInterfaceDump) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *MplsInterfaceDump) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *MplsInterfaceDump) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
}

// Bind/Unbind an MPLS local label to an IP prefix. i.e. create
//
...
//   - mr_is_multipath - Is this route update a multipath - i.e. is this
...
//   - mt_name - A client provided name/tag for the table. If this
...
//   - sw_if_index - sw_if_index of the MPLS tunnel
...
func file_mpls_binapi_init() {
	api.RegisterMessage((*MplsInterfaceDetails)(nil), "mpls_interface_details_0b45011c")
	api.RegisterMessage((*MplsInterfaceDump)(nil), "mpls_interface_dump_f9e6675e")
...
func AllMessages() []api.Message {
	return []api.Message{
		(*MplsInterfaceDetails)(nil),
		(*MplsInterfaceDump)(nil),
