...
// SflowDirectionGet defines message 'sflow_direction_get'.
type SflowDirectionGet struct{}

func (m *SflowDirectionGet) Reset()               { *m = SflowDirectionGet{} }
func (*SflowDirectionGet) GetMessageName() string { return "sflow_direction_get" }
func (*SflowDirectionGet) GetCrcString() string   { return "51077d14" }
...
//
// SflowDirectionGetReply defines message 'sflow_direction_get_reply'.
// InProgress: the message form may change in the future versions
type SflowDirectionGetReply struct {
	SamplingD uint32 `binapi:"u32,name=sampling_D" json:"sampling_D,omitempty"`
}

func (m *SflowDirectionGetReply) Reset()               { *m = SflowDirectionGetReply{} }
func (*SflowDirectionGetReply) GetMessageName() string { return "sflow_direction_get_reply" }
func (*SflowDirectionGetReply) GetCrcString() string   { return "f3316252" }
...
func (m *SflowDirectionGetReply) Marshal(b []byte) ([]byte, error) {
	...
	buf := codec.NewBuffer(b)
	buf.EncodeUint32(m.SamplingD)
	return buf.Bytes(), nil
}
func (m *SflowDirectionGetReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SamplingD = buf.DecodeUint32()
	return nil
}
...
func (m *SflowDirectionSet) Reset()               { *m = SflowDirectionSet{} }
func (*SflowDirectionSet) GetMessageName() string { return "sflow_direction_set" }
func (*SflowDirectionSet) GetCrcString() string   { return "fbca6f34" }
...
func (m *SflowDirectionSetReply) Reset()               { *m = SflowDirectionSetReply{} }
func (*SflowDirectionSetReply) GetMessageName() string { return "sflow_direction_set_reply" }
func (*SflowDirectionSetReply) GetCrcString() string   { return "e8d4e804" }
...
// SflowDropMonitoringGet defines message 'sflow_drop_monitoring_get'.
type SflowDropMonitoringGet struct{}

func (m *SflowDropMonitoringGet) Reset()               { *m = SflowDropMonitoringGet{} }
func (*SflowDropMonitoringGet) GetMessageName() string { return "sflow_drop_monitoring_get" }
func (*SflowDropMonitoringGet) GetCrcString() string   { return "51077d14" }
...
//
// SflowDropMonitoringGetReply defines message 'sflow_drop_monitoring_get_reply'.
// InProgress: the message form may change in the future versions
type SflowDropMonitoringGetReply struct {
	DropM uint32 `binapi:"u32,name=drop_M" json:"drop_M,omitempty"`
}

func (m *SflowDropMonitoringGetReply) Reset()               { *m = SflowDropMonitoringGetReply{} }
func (*SflowDropMonitoringGetReply) GetMessageName() string { return "sflow_drop_monitoring_get_reply" }
func (*SflowDropMonitoringGetReply) GetCrcString() string   { return "b56ae30e" }
...
func (m *SflowDropMonitoringSet) Reset()               { *m = SflowDropMonitoringSet{} }
func (*SflowDropMonitoringSet) GetMessageName() string { return "sflow_drop_monitoring_set" }
func (*SflowDropMonitoringSet) GetCrcString() string   { return "100b1e04" }
...
func (m *SflowDropMonitoringSetReply) Reset()               { *m = SflowDropMonitoringSetReply{} }
func (*SflowDropMonitoringSetReply) GetMessageName() string { return "sflow_drop_monitoring_set_reply" }
func (*SflowDropMonitoringSetReply) GetCrcString() string   { return "e8d4e804" }
...
func file_sflow_binapi_init() {
	api.RegisterMessage((*SflowDirectionGet)(nil), "sflow_direction_get_51077d14")
	api.RegisterMessage((*SflowDirectionGetReply)(nil), "sflow_direction_get_reply_f3316252")
	api.RegisterMessage((*SflowDirectionSet)(nil), "sflow_direction_set_fbca6f34")
	api.RegisterMessage((*SflowDirectionSetReply)(nil), "sflow_direction_set_reply_e8d4e804")
	api.RegisterMessage((*SflowDropMonitoringGet)(nil), "sflow_drop_monitoring_get_51077d14")
	api.RegisterMessage((*SflowDropMonitoringGetReply)(nil), "sflow_drop_monitoring_get_reply_b56ae30e")
	api.RegisterMessage((*SflowDropMonitoringSet)(nil), "sflow_drop_monitoring_set_100b1e04")
	api.RegisterMessage((*SflowDropMonitoringSetReply)(nil), "sflow_drop_monitoring_set_reply_e8d4e804")
...
func AllMessages() []api.Message {
	return []api.Message{
		(*SflowDirectionGet)(nil),
		(*SflowDirectionGetReply)(nil),
		(*SflowDirectionSet)(nil),
		(*SflowDirectionSetReply)(nil),
		(*SflowDropMonitoringGet)(nil),
		(*SflowDropMonitoringGetReply)(nil),
		(*SflowDropMonitoringSet)(nil),
		(*SflowDropMonitoringSetReply)(nil),
