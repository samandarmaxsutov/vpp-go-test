...
//   - sw_if_index - interface index on which clamping is applied
//   - ipv4_mss - Maximum Segment Size for IPv4/TCP
//   - ipv6_mss - Maximum Segment Size for IPv6/TCP
//   - ipv4_direction - Direction clamping is enabled on (IPv4/TCP)
//   - ipv6_direction - Direction clamping is enabled on (IPv6/TCP)
//
...
//   - sw_if_index - interface index on which clamping will be applied
//   - ipv4_mss - Maximum Segment Size for IPv4/TCP
//   - ipv6_mss - Maximum Segment Size for IPv6/TCP
//   - ipv4_direction - Direction clamping is enabled on (IPv4/TCP)
//   - ipv6_direction - Direction clamping is enabled on (IPv6/TCP)
...
//   - sw_if_index - interface index to filter the result,
//     ~0 means no filter
//
