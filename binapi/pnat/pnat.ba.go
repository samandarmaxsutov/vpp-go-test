...
func (m *PnatFlowLookup) Reset()               { *m = PnatFlowLookup{} }
func (*PnatFlowLookup) GetMessageName() string { return "pnat_flow_lookup" }
func (*PnatFlowLookup) GetCrcString() string   { return "1ef8747c" }
...
func (m *PnatFlowLookupReply) Reset()               { *m = PnatFlowLookupReply{} }
func (*PnatFlowLookupReply) GetMessageName() string { return "pnat_flow_lookup_reply" }
func (*PnatFlowLookupReply) GetCrcString() string   { return "4cd980a7" }
...
func file_pnat_binapi_init() {
	...
	api.RegisterMessage((*PnatFlowLookup)(nil), "pnat_flow_lookup_1ef8747c")
	api.RegisterMessage((*PnatFlowLookupReply)(nil), "pnat_flow_lookup_reply_4cd980a7")
